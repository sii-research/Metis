...
ARGS+=" --q-forward-input mxfp4e2m1bnosr"
ARGS+=" --q-forward-weight mxfp4e2m1bnosr"
ARGS+=" --q-backward-input mxfp4e2m1bnosr"
ARGS+=" --q-backward-weight mxfp4e2m1bnosr"
ARGS+=" --q-backward-outputgrad mxfp4e2m1b"
ARGS+=" --enable-lowbit"
ARGS+=" --activation-metis-mode svd"
ARGS+=" --gout-metis-mode svd"
